    ...
    implements Data
{
    ...
    @Override
    public getCurrentWeather GetCurrentWeather() {
        try {
            return restTemplate.exchange(rootUrl.concat(""), HttpMethod.GET, null, getCurrentWeather.class).getBody();
